...
![Authentication Flow Diagram](./authentication-process-with-bg.png)
...
![Password Hashing Diagram](./password-hashing.png)

In older systems, passwords were sometimes stored in plain text — that’s a serious security risk.
In modern PHP, we never store passwords directly. We store a **hash** — a one-way, irreversible representation.
...
This ensures that even the site administrator can’t see the raw passwords.
...
![PHP Security Features](./php-security-features.png)
