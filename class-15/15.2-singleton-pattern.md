...
If this sounds familiar, it should! Throughout the course, we've used a `Database` class that used static methods to manage a single PDO connection. The Singleton pattern formalizes this idea.
