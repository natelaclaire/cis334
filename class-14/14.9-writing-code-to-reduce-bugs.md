...
## 9. Avoid [“Magic Numbers”](https://en.wikipedia.org/wiki/Magic_number_(programming)) and Strings
...
* Run `php -l filename.php` to check syntax ([phplint](https://github.com/overtrue/phplint) is another option)
