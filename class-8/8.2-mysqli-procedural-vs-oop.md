...
**Goal:** Write the same program twice — once procedural, once OOP.

**Task:**
Create a script that:

1. Connects to a database.
2. Runs a `SELECT` query on a `students` table (`id`, `first_name`, `last_name`).
3. Displays the results as an HTML table.
4. Handles errors gracefully.

Then:

* Save as `students_procedural.php` and `students_oop.php`.
* Compare the syntax and discuss: Which version is easier to read, debug, and maintain?
